...
if (experimental) {
    experimental.addEventListener("click", function () {
        window.open("english.html?tab=experimental");
    })
}
if (experimentalMobile) {
...
if (involveAndForm) {
    involveAndForm.addEventListener("click", function () {
        window.open("english.html?tab=involveAndForm");
    });
}
...
if (multidisciplinary) {
    multidisciplinary.addEventListener("click", function () {
        window.open("english.html?tab=multidisciplinary");
    });
}
...
if (programPace) {
    programPace.addEventListener("click", function () {
        window.open("english.html?tab=programPace");
    });
}
...
if (concreteCase) {
    concreteCase.addEventListener("click", function () {
        window.open("english.html?tab=concreteCase");
    });
}
...
if (ecosysteme) {
    ecosysteme.addEventListener("click", function () {
        window.open("english.html?tab=ecosysteme");
    });
}
if (ecosystemeMobile) {
...
if (project) {
    project.addEventListener("click", function () {
        window.open("english.html?tab=project");
    });
}
if (programPaceMobile) {
